        ...
        <div class="container py-5 h-100">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row align-items-center">
                                                ...
                                                <input type="text" id="notet" name="n" class="form-control form-control-lg"
                                                    placeholder="Add new...">
                                                {{-- <a href="#!" data-mdb-toggle="tooltip" title="Set due date"><i
                                                        class="fas fa-calendar-alt fa-lg me-3"></i></a> --}}
                                                        <div>
                                                            <button id="add_fnote" type="submit" class="btn btn-primary">Add</button>
                                                        </div>
                            </form>
                        </div>
                    </div>
            ...
            <div id="ii">
                ...
                <ul class="list-group list-group-horizontal rounded-0 mb-2">
                    ...
                    <li class="list-group-item px-3 py-1 d-flex align-items-center flex-grow-1 border-0 bg-transparent">
                        <p class="lead fw-normal mb-0 bg-light w-100 ms-n2 ps-2 py-1 rounded">Sign up for online course
                        </p>
                    </li>
                    <li class="list-group-item ps-3 pe-0 py-1 rounded-0 border-0 bg-transparent">
                        <div class="d-flex flex-row justify-content-end mb-1">
